...
//Writing "Hello world", where 0x40 is the control byte and 0xA0 is a hex value for "space"
...
void main(void){
	...
	TransferConfig.tx_length = 12; //The length of the list of commands we are sending
	TransferConfig.sl_addr7bit = 59; //The address where e send this list
	TransferConfig.tx_data = initScreen; //The name of the list
